...
export default function RosterView(props) {
  ...
  return (
    <div className="rosterview">
            ...
            <form onSubmit={handleAddStudent}>
              ...
              <div className="form-checks">
                <FormGroup>
                  <Form.Check
                    type="checkbox"
                    label="I can make good choices even if I am mad."
                    checked={hasGoalOne}
                    onChange={handleCheckOne}
                  />
                  <Form.Check
                    type="checkbox"
                    label="I can be okay even if others are not okay."
                    checked={hasGoalTwo}
                    onChange={handleCheckTwo}
                  />
                  <Form.Check
                    type="checkbox"
                    label="I can do something even if I don't want to (or it's hard)."
                    checked={hasGoalThree}
      ...
      <button onClick={props.switchToGroups} className="switch-view-btn">
